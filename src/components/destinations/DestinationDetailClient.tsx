...
fbq('track', 'PageView');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 relative z-10">
        {/* Food Spots Not Available Message — commented out, stays only
        {(category === "restaurants-cafes" || category === "getaways") && trips.length === 0 && (
          ...
          >
            ... Food Spots Coming Soon section ...
          </motion.section>
        )}
        */}
                ...
                {section.items.slice(0, 8).map((item, index) => (
                  ...
                  >
                    ...
                    <div className="relative h-48 sm:h-56 overflow-hidden">
                      ...
                      {section.type === "stay" && item.startingPrice > 0 && (
                        <motion.div
                    ...
                    <div className="p-4 sm:p-5 flex flex-col">
                      ...
                      {/* Activities & trips duration — commented out with non-stay sections
                      {section.type !== "stay" && (() => {
      ...
      <LeadFormPopup
        ...
        itemName={leadPopupStay?.name ?? destination?.name}
        itemType={leadPopupStay ? "stay" : undefined}
        itemPrice={
          leadPopupStay && leadPopupStay.startingPrice > 0
